...
export class Dataset {
     ...
     */
    public async upload(client: AbstractClient): Promise<Dataset> {
    ...
    private async createDataset(client: AbstractClient, bindings: Record<string, unknown>): Promise<string> {
