...
DIST_JS_UPLOAD_API=${DIST_JS_UPLOAD_API:-projects/js-upload-api/dist}
...
echo "="
echo "===================="
echo "Extracting JS binaries from graphistry/graphistry-js:latest into path projects/{client,node,js-upload}-api[-react]/dist"
echo " (DIST_CLIENT_API, DIST_CLIENT_API_REACT, DIST_NODE_API, DIST_JS_UPLOAD_API)"
echo
echo "---------------"
echo
echo "Settings:"
